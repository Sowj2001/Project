...
class orderController {
    paymentCheck = async (id) => {
        try {
            ...
            if (order.payment_status === "unpaid") {
                ...
                await authOrderModel.updateMany({ orderId: id }, { delivery_status: "pending" });
            }
            return true;
        } catch (error) {
            console.error("Error in paymentCheck:", error);
        }
    };
    ...
    get_customer_dashboard_data = async (req, res) => {
        ...
        try {
            ...
            const cancelledOrder = await customerOrder.find({ customerId: new ObjectId(userId), delivery_status: "pending" }).countDocuments();
            responseReturn(res, 200, { recentOrders, pendingOrder, totalOrder, cancelledOrder });
        } catch (error) {
            console.error("Error in get_customer_dashboard_data:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    get_order_details = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in get_order_details:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    get_admin_orders = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in get_admin_orders:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    get_admin_order = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in get_admin_order:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    admin_order_status_update = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in admin_order_status_update:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    get_seller_order = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in get_seller_order:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    seller_order_status_update = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in seller_order_status_update:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
    ...
    order_confirm = async (req, res) => {
        ...
        try {
            ...
            console.error("Error in order_confirm:", error);
            responseReturn(res, 500, { message: "Internal Server Error" });
        }
    };
}
