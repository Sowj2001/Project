        ...
        <tbody>
            {
                ...
                <td  className='py-1 px-4 font-medium whitespace-nowrap'>Sowjanya </td>
                <td  className='py-1 px-4 font-medium whitespace-nowrap'>Easy shop</td>
                <td  className='py-1 px-4 font-medium whitespace-nowrap'>
                    <span>Pending</span> </td>
                <td  className='py-1 px-4 font-medium whitespace-nowrap'>sowjanya@gmail.com </td>

                <td 
                 className='py-1 px-4 font-medium whitespace-nowrap'>kaup </td>

                <td 
                 className='py-1 px-4 font-medium whitespace-nowrap'>udupi </td>
