...
const Login = () => {
    ...
    return (
        <div className='min-w-screen min-h-screen bg-cover bg-center flex justify-center items-center'
            ...
            <div className='w-full max-w-md p-6 bg-opacity-80 rounded-lg shadow-lg'>
                <div className='bg-white p-8 rounded-lg'>
                    <h2 className='text-2xl mb-4 font-bold text-gray-800 text-center'>Welcome to BizCart4all</h2>
                    ...
                    <div className='mt-4 text-center'>
                        <p className='text-sm text-gray-600'>Don't have an account? <Link to='/register' className='font-bold text-blue-500'>Sign Up</Link></p>
                    </div>
